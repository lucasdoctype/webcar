...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <body>
    ...
    <div class="container">
      ...
      <h1 class="my-4">Peugeot:</h1>

      <!-- Marketing Icons Section -->
      <div class="row">
        <div class="col-lg-4 mb-4">
          <div class="card h-100">
            <h4 class="card-header">Peugeot 3008</h4>
            <div class="card-body">
              <img src="imagens/3008.png" style="width: 300px; height: 225px;">
              <h5>A partir de R$140.000!</h5>
            </div>
            <div class="card-footer">
              <a href="3008.php" class="btn btn-danger">Detalhes</a>
            </div>
          </div>
        </div>
        <div class="col-lg-4 mb-4">
          <div class="card h-100">
            <h4 class="card-header">Peugeot 208</h4>
            <div class="card-body">
              <img src="imagens/208.png" style="width: 300px; height: 225px;">
              <h5>A partir de R$50.000!</h5>
            </div>
            <div class="card-footer">
              <a href="208.php" class="btn btn-danger">Detalhes</a>
            </div>
          </div>
        </div>
        <div class="col-lg-4 mb-4">
          <div class="card h-100">
            <h4 class="card-header">Peugeot 2008</h4>
            <div class="card-body">
              <img src="imagens/2008.png" style="width: 300px; height: 225px;">
              <h5>A partir de R$65.000!</h5>
            </div>
            <div class="card-footer">
              <a href="2008.php" class="btn btn-danger">Detalhes</a>
            </div>
          </div>
        </div>
      </div>
