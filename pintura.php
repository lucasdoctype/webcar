  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="contato.php" style="color: white;">Contato</a>
            </li>
    ...
    <div class="container">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Pintura</li>
      </ol>
      ...
      <div class="row">
        <div class="col-lg-4 mb-4">
          <div class="card h-100">
            <h4 class="card-header">Pintura comum</h4>
            <div class="card-body">
              <img src="imagens/pintura.png" style="width: 307.5px; height: 200px; margin-bottom: 15px;">
              Preço/Hora - R$150,00
            </div>
        ...
        <div class="col-lg-4 mb-4">
          <div class="card h-100">
            <h4 class="card-header">Pintura personalizada</h4>
            <div class="card-body">
              <img src="imagens/pintura2.png" style="width: 307.5px; height: 200px; margin-bottom: 15px;">
              Preço/Hora - R$150,00
            </div>
            <div class="card-footer">
              <button class="btn btn-danger">Entrar em contato</button>
        ...
        <div class="col-lg-4 mb-4">
          <div class="card h-100">
            <h4 class="card-header">Pintura com Aerógrafo</h4>
            <div class="card-body">
              <img src="imagens/pintura3.png" style="width: 307.5px; height: 200px; margin-bottom: 15px;">
              Preço/Hora - R$150,00
            </div>
            <div class="card-footer">
              <button class="btn btn-danger">Entrar em contato</button>
      ...
      <div class="row" style="margin-top: 10px;">
        <div class="col-lg-4 mb-4">
          <div class="card h-100">
            <h4 class="card-header">Pintura com Flake</h4>
            <div class="card-body">
              <img src="imagens/pintura4.png" style="width: 307.5px; height: 200px; margin-bottom: 15px;">
              Preço/Hora - R$180,00
            </div>
            <div class="card-footer">
              <button class="btn btn-danger">Entrar em contato</button>
