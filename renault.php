...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <body>
    ...
    <div class="container">
      ...
      <h1 class="my-4">Renault:</h1>

      <!-- Marketing Icons Section -->
      <div class="row">
        <div class="col-lg-4 mb-4">
          <div class="card h-100">
            <h4 class="card-header">Kwid</h4>
            <div class="card-body">
              <img src="imagens/kwid.png" style="width: 300px; height: 225px;">
              <h5>A partir de R$30.000!</h5>
            </div>
            <div class="card-footer">
              <a href="kwid.php" class="btn btn-danger">Detalhes</a>
            </div>
          </div>
        </div>
        <div class="col-lg-4 mb-4">
          <div class="card h-100">
            <h4 class="card-header">Sandero</h4>
            <div class="card-body">
              <img src="imagens/sandero.png" style="width: 300px; height: 225px; margin-top: -15px;">
              <h5>A partir de R$40.000!</h5>
            </div>
            <div class="card-footer">
              <a href="sandero.php" class="btn btn-danger">Detalhes</a>
            </div>
          </div>
        </div>
        <div class="col-lg-4 mb-4">
          <div class="card h-100">
            <h4 class="card-header">Duster</h4>
            <div class="card-body">
              <img src="imagens/duster.png" style="width: 300px; height: 225px;">
              <h5>A partir de R$70.000!</h5>
            </div>
            <div class="card-footer">
              <a href="duster.php" class="btn btn-danger">Detalhes</a>
            </div>
          </div>
        </div>
      </div>
