  ...
  <body>
    ...
    <div class="container">
      <div class="row" style="margin-top: 100px;">
        <div class="col-lg-6">
          <img class="img-fluid rounded" src="imagens/3008.png" alt="">
        </div>
        <div class="col-lg-6">
          <h2>Peugeot 3008 2018</h2>
          <p>1.6 ALLURE THP 16V GASOLINA 4P AUTOMÁTICO</p>
          <h2>R$140.000</h2>
      ...
      <div class="row mb-4">
        <div class="col-md-4">
          <a class="btn btn-lg btn-danger btn-block" href="#">Enviar mensagem</a>
        </div>
      </div>
    </div>
    <!-- /.container -->
